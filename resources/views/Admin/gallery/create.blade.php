...
<!--begin::Entry-->
												...
												<div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
													<div class="wizard-wrapper">
														...
														<div class="wizard-label">
															<div class="wizard-title">Add Gallery</div> <a href="{{ url('gallery') }}"><button class="p-2 rounded btn-primary">Back</button></a>
    ...
    @endif
														<form class="form" id="kt_form" action="{{ route('gallery.store') }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
