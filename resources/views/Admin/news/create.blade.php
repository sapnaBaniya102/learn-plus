...
<!--begin::Entry-->
												...
												<div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
													<div class="wizard-wrapper">
														...
														<div class="wizard-label">
															<div class="wizard-title">Add News</div><a href="{{ url('news') }}"><button class="p-2 rounded btn-primary">Back</button></a>
    ...
    @endif
														<form class="form" id="kt_form" action="{{ route('news.store') }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
																	...
																	<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																		...
																		<div class="form-group row">
																			...
																			<div class="col-lg-9 col-xl-9">
																				<input class="form-control form-control-solid form-control-lg" name="title" type="text"  />
																			</div>
																		</div>
																		<!--end::Group-->
																		<!--begin::Group-->
